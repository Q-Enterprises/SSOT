...
Example: _"I need to search repositories for the latest seL4 drivers."_
...
- **outputs**:
  - `<name>`: `<type>` — `<constraints>`
- **preconditions**:
  - `<required states, approvals, or data>`
- **postconditions**:
  - `<expected state changes or artifacts>`
- **failure_modes**:
...
- **unit_test_scaffold**:
  - `<test name>`: `<purpose>`
- **static_audit**:
  - `<linter, ruleset, pass/fail criteria>`
- **deterministic_run**:
